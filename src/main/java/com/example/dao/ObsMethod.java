    ...
    public int start() {
        ...
        insertToPMCISTable(tableName, listMap, new FieldHelper() {
            ...
            public void editMapForUpdate(Map<String, Object> map) {
                ...
                String old_C_SNETSHIP_ID = instPK.substring(0,36);
                String C_SNETSHIP_ID = netPKMap.get(old_C_SNETSHIP_ID);
