...
CREATE TABLE `TAB_OMIN_CM_CC_OBSVCRIT` (
      ...
      `ENDTIME` VARCHAR(20) NOT NULL COMMENT '终止时间',
      `NAMEANDVER` VARCHAR(100) NOT NULL COMMENT '规范名称和版本',
      `ISSUEORG` VARCHAR(50) NOT NULL COMMENT '发布单位',
      ...
      `C_OPT_STATUS` VARCHAR(8) DEFAULT NULL COMMENT '操作状态',
...
CREATE TABLE `TAB_OMIN_CM_CC_SUMMARY` (
      ...
      `STARTTIME` VARCHAR(20) NOT NULL COMMENT '纪要起始时间',
      `ENDTIME` VARCHAR(20) NOT NULL COMMENT '纪要起始时间',
      `SUMMARY_EVENT` VARCHAR(200) NOT NULL COMMENT '纪要内容',
      `SUMMARYEVENTID` NUMERIC(5) NOT NULL COMMENT '纪要事件类型标识',
      `C_CREATE_DATE` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
      `C_UPDATED_DATE` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
      `C_MODIFIER` VARCHAR(36) DEFAULT NULL COMMENT '最近更新人',
      `C_OPT_STATUS` VARCHAR(8) DEFAULT NULL COMMENT '操作状态',
...
CREATE TABLE `TAB_OMIN_CM_CC_WEATHERDESC` (
      ...
      `RECDTIME` VARCHAR(30) NOT NULL COMMENT '记录时间',
      `FEATURE` VARCHAR(2000) NOT NULL COMMENT '气候特点',
      ...
      `OVERALLEVALUATION` VARCHAR(2000) NOT NULL COMMENT '综合评价',
      `C_CREATE_DATE` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
      `C_UPDATED_DATE` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
      `C_MODIFIER` VARCHAR(36) DEFAULT NULL COMMENT '最近更新人',
      `C_OPT_STATUS` VARCHAR(8) DEFAULT NULL COMMENT '操作状态',
...
CREATE TABLE `TAB_OMIN_CM_CC_NOTEEVENT` (
      ...
      `GENERALEVENTID` NUMERIC(5) NOT NULL COMMENT '备注项一般事件ID',
      `STARTTIME` VARCHAR(20) NOT NULL COMMENT '起始时间',
      `ENDTIME` VARCHAR(20) NOT NULL COMMENT '终止时间',
      `GENERALEVENTDESC` VARCHAR(2000) DEFAULT NULL COMMENT '备注项一般事件',
      `EVENTTYPE` NUMERIC(5) NOT NULL COMMENT '备注事件类型',
...
CREATE TABLE `TAB_OMIN_CM_CC_OBSTACLE` (
      ...
      `OBSTSN` VARCHAR(20) NOT NULL COMMENT '障碍物编号',
      `OBSTCLASS` VARCHAR(20) NOT NULL COMMENT '障碍物名称',
      `DIRECTION` VARCHAR(20) NOT NULL COMMENT '方位',
      `ELEVANGLE` VARCHAR(20) NOT NULL COMMENT '仰角',
      `WIDTHANGLE` VARCHAR(20) NOT NULL COMMENT '宽度角',
...
CREATE TABLE `TAB_OMIN_CM_CC_POLLUTE` (
      ...
      `POLLUTESN` VARCHAR(20) NOT NULL COMMENT '污染物编号',
...
CREATE TABLE `TAB_OMIN_CM_CC_DOUCUMENT` (
      `PDOCUMENT` VARCHAR(4) NOT NULL COMMENT '文件类型',
      ...
      `TRANSFERDATE` VARCHAR(50) NOT NULL COMMENT '开始时间',
      `MAKETIME` VARCHAR(50) NOT NULL COMMENT '结束时间',
...
CREATE TABLE `TAB_OMIN_CM_CC_INSTMODEL` (
      ...
      `INSTMODEL` VARCHAR(50) NOT NULL COMMENT '仪器型号',
      `INSTNAME` VARCHAR(50) NOT NULL COMMENT '仪器名称',
      `INSTCOMP` VARCHAR(60) NOT NULL COMMENT '生产厂家',
      `INSTNUM` VARCHAR(30) NOT NULL COMMENT '号码组',
...
CREATE TABLE `TAB_OMIN_CM_CC_NETWORK_SOIL_BAK` (
      `NETWORKSOPK` VARCHAR(36) NOT NULL COMMENT '站网主键',
...
CREATE TABLE `TAB_OMIN_CM_CC_YEAR_CLIMATE` (
      ...
      `C_TIME` VARCHAR(30) NOT NULL COMMENT '年报年份',
      `C_MAIN` VARCHAR(2000) NOT NULL COMMENT '主要天气气候特征',
      ...
      `C_SYNTHETICAL` VARCHAR(2000) NOT NULL COMMENT '本年天气气候综合评价',
      `C_CREATE_DATE` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
      `C_UPDATED_DATE` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
      `C_MODIFIER` VARCHAR(36) DEFAULT NULL COMMENT '最近更新人',
      `C_OPT_STATUS` VARCHAR(8) DEFAULT NULL COMMENT '操作状态',
...
CREATE TABLE `TAB_OMIN_CM_CC_YEAR_INSTRUMENTS` (
      ...
      `STATION_ID` VARCHAR(100) NOT NULL COMMENT '台站主键',
      `APPLIANCE_ID` VARCHAR(20) NOT NULL COMMENT '仪器代码',
      `APPLIANCE_NAME` VARCHAR(100) NOT NULL COMMENT '仪器名称',
      `I_FACTORY` VARCHAR(200) NOT NULL COMMENT '厂名',
      `I_TIME` VARCHAR(30) NOT NULL COMMENT '检定时间',
      `I_MODELS` VARCHAR(500) NOT NULL COMMENT '仪器型号组',
      `I_NUMBERS` VARCHAR(500) NOT NULL COMMENT '号码组',
      `N_TIME` VARCHAR(30) NOT NULL COMMENT '年报日期',
      `C_CREATE_DATE` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
      `C_UPDATED_DATE` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
      `C_MODIFIER` VARCHAR(36) DEFAULT NULL COMMENT '最近更新人',
      `C_OPT_STATUS` VARCHAR(8) DEFAULT NULL COMMENT '操作状态',
...
CREATE TABLE `TAB_OMIN_CM_CC_YEAR_REMARK` (
      ...
      `STATION_ID` VARCHAR(100) NOT NULL COMMENT '台站主键',
      `R_TIME` VARCHAR(30) NOT NULL COMMENT '备注起止时间',
      `R_CONTENT` VARCHAR(2000) NOT NULL COMMENT '备注内容',
      `C_CREATE_DATE` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
      `C_UPDATED_DATE` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
      `C_MODIFIER` VARCHAR(36) DEFAULT NULL COMMENT '最近更新人',
      `C_OPT_STATUS` VARCHAR(8) DEFAULT NULL COMMENT '操作状态',
